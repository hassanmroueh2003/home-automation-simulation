...
import glob  # Importing the glob module for pathname pattern expansion
...
class SimpleFacerec:
    ...
    def load_encoding_images(self, images_path):
        ...
        for img_path in images_path:
            ...
            # Get the filename only from the initial file path  and Extract filename without extension
    ...
    def detect_known_faces(self, frame):
        ...
        for face_encoding in face_encodings:
            # See if the face is a match for the known face(s) so we compare face encodings with known face encodings
